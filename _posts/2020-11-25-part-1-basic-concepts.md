...
*Note: I assume that you have basic knowledge of probability theory. For the sake of brevity, the next section only recaps some random process concepts, which are used to develop the model's ideas.*
